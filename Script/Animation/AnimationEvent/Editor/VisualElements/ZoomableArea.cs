...
namespace Framework
{
    ...
    internal class ZoomableArea
    {
            ...
            public void InitGUIStyles(bool minimalGUI, bool enableSliderZoomHorizontal, bool enableSliderZoomVertical)
            {
                    ...
                    if (minimalSliderStyles == null)
                    {
                        minimalSliderStyles = new SliderTypeStyles()
                        {
                            scrollbar = new SliderTypeStyles.SliderAxisStyles()
                                {horizontal = "MiniSliderhorizontal", vertical = "MiniSliderVertical"},
                            minMaxSliders = new SliderTypeStyles.SliderAxisStyles()
                            {
                                horizontal = "MiniMinMaxSliderHorizontal", vertical = "MiniMinMaxSlidervertical"
                            },
                        };
                    }
                ...
                else
                {
                    if (normalSliderStyles == null)
                    {
                        ...
                        {
                            scrollbar = new SliderTypeStyles.SliderAxisStyles()
                                {horizontal = "horizontalscrollbarthumb", vertical = "verticalscrollbarthumb"},
                            minMaxSliders = new SliderTypeStyles.SliderAxisStyles()
                            {
                                horizontal = "horizontalMinMaxScrollbarThumb", vertical = "verticalMinMaxScrollbarThumb"
                            },
                        };
                    }
        ...
        public Rect rect
        {
            get
            {
                return new Rect(drawRect.x, drawRect.y, drawRect.width + (m_VSlider ? styles.visualSliderWidth : 0),
                    drawRect.height + (m_HSlider ? styles.visualSliderWidth : 0));
            }
            set
            {
                Rect newDrawArea = new Rect(value.x, value.y, value.width - (m_VSlider ? styles.visualSliderWidth : 0),
                ...
                if (newDrawArea != m_DrawArea)
                {
                    ...
                    {
                        m_Translation += new Vector2((newDrawArea.width - m_DrawArea.width) / 2,
        ...
        float GetWidthInsideMargins(float widthWithMargins, bool substractSliderWidth = false)
        {
            ...
            float widthInsideMargins = width - leftmargin - rightmargin -
        ...
        float GetHeightInsideMargins(float heightWithMargins, bool substractSliderHeight = false)
        {
            ...
            float heightInsideMargins = height - topmargin - bottommargin -
        ...
        {
            get { return Matrix4x4.TRS(m_Translation, Quaternion.identity, new Vector3(m_Scale.x, m_Scale.y, 1)); }
        }
        ...
        public ZoomableArea(bool minimalGUI, bool enableSliderZoom) : this(minimalGUI, enableSliderZoom,
            enableSliderZoom)
        {
        }
        ...
        public void BeginViewGUI()
        {
            ...
            horizontalScrollbarID = GUIUtility.GetControlID("MinMaxSlider".GetHashCode(), FocusType.Passive);
            verticalScrollbarID = GUIUtility.GetControlID("MinMaxSlider".GetHashCode(), FocusType.Passive);
        ...
        void SliderGUI()
        {
            ...
            using (new EditorGUI.DisabledScope(!enableMouseInput))
            {
                ...
                if (m_HSlider)
                {
                    Rect hRangeSliderRect = new Rect(drawRect.x + 1, drawRect.yMax - inset, drawRect.width - otherInset,
                        styles.sliderWidth);
                    ...
                    {
                        shownXMin = EditorGUIExt.Scroller(hRangeSliderRect,
                ...
                if (m_VSlider)
                {
                    if (m_UpDirection == YDirection.Positive)
                    {
                        Rect vRangeSliderRect = new Rect(drawRect.xMax - inset, drawRect.y, styles.sliderWidth,
                        ...
                        {
                            shownYMin = EditorGUIExt.Scroller(vRangeSliderRect,

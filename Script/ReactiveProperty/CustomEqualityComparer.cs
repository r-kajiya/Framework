...
namespace Framework
{
    public static class CustomEqualityComparer
    {
        ...
        public static IEqualityComparer<T> Get<T>()
        {
            ...
            if (t.Equals(vector2Type)) return (IEqualityComparer<T>)CustomEqualityComparer.Vector2;
            if (t.Equals(vector3Type)) return (IEqualityComparer<T>)CustomEqualityComparer.Vector3;
            if (t.Equals(vector4Type)) return (IEqualityComparer<T>)CustomEqualityComparer.Vector4;
            if (t.Equals(colorType)) return (IEqualityComparer<T>)CustomEqualityComparer.Color;
            if (t.Equals(rectType)) return (IEqualityComparer<T>)CustomEqualityComparer.Rect;
            if (t.Equals(boundsType)) return (IEqualityComparer<T>)CustomEqualityComparer.Bounds;
            if (t.Equals(quaternionType)) return (IEqualityComparer<T>)CustomEqualityComparer.Quaternion;
